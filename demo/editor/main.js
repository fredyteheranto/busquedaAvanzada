...
var files = [{
    ...
    text: multiline(function() {
        ...
        System.config({
          ...
          map: {
            ...
            'busqueda-avanzada-adn30':            'npm:busqueda-avanzada-adn30@0.3.2/dist/index.umd.js'
          }
        });
        */
    })
    ...
    text: multiline(function() {
        ...
        <h2>Vanilla</h2>
        <br>
        <busqueda-avanzada-adn [formControl]='queryCtrl' [config]='currentConfig'>
        ...
        <h2>Bootstrap</h2>
        <br>
        <busqueda-avanzada-adn [(ngModel)]='query' [classNames]='bootstrapClassNames' [config]='currentConfig'>
    ...
    text: multiline(function() {
        ...
        import { BusquedaAvanzadaAdn30Config, BusquedaAvanzadaAdn30ClassNames } from "busqueda-avanzada-adn30";
