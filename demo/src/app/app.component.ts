...
import { BusquedaAvanzadaAdn30ClassNames, BusquedaAvanzadaAdn30Config } from '../../lib';
...
@Component({
  ...
  <h2>Vanilla</h2>
  <br>
  <busqueda-avanzada-adn [formControl]='queryCtrl' [config]='currentConfig' [allowRuleset]='allowRuleset' [allowCollapse]='allowCollapse'>
  ...
  <br>
  <mat-card>
  <busqueda-avanzada-adn [(ngModel)]='query' [config]='currentConfig' [allowRuleset]='allowRuleset' [allowCollapse]='allowCollapse'>
  ...
  <h2>Bootstrap</h2>
  <br>
  <busqueda-avanzada-adn [(ngModel)]='query' [classNames]='bootstrapClassNames' [config]='currentConfig' [allowRuleset]='allowRuleset' [allowCollapse]='allowCollapse'>
...
export class AppComponent {
  ...
  public bootstrapClassNames: BusquedaAvanzadaAdn30ClassNames = {
  ...
  public entityConfig: BusquedaAvanzadaAdn30Config = {
    entities: {
  ...
  public config: BusquedaAvanzadaAdn30Config = {
    fields: {
  ...
  public currentConfig: BusquedaAvanzadaAdn30Config;
